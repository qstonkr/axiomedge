...
class TestListKbs:
    @patch("services.api.kb._get")
    def test_list_kbs_no_filter(self, mock_get):
    ...
    @patch("services.api.kb._get")
    def test_list_kbs_with_tier_filter(self, mock_get):
    ...
    @patch("services.api.kb._get")
    def test_list_kbs_with_status_filter(self, mock_get):
        mock_get.return_value = {"items": []}
...
class TestKBCrud:
    ...
    @patch("services.api.kb._post")
    def test_create_kb(self, mock_post):
    ...
    @patch("services.api.kb._put")
    def test_update_kb(self, mock_put):
    ...
    @patch("services.api.kb._delete")
    def test_delete_kb(self, mock_delete):
...
class TestUpdatePublishStrategy:
    @patch("services.api.kb.update_kb")
    @patch("services.api.kb.get_kb")
    def test_sets_strategy_in_settings(self, mock_get, mock_update):
    ...
    @patch("services.api.kb.update_kb")
    @patch("services.api.kb.get_kb")
    def test_normalizes_strategy_lowercase(self, mock_get, mock_update):
    ...
    @patch("services.api.kb.update_kb")
    @patch("services.api.kb.get_kb")
    def test_defaults_to_legacy_when_none(self, mock_get, mock_update):
        mock_get.return_value = {"settings": {}}
        mock_update.return_value = {}
    ...
    @patch("services.api.kb.get_kb")
    def test_returns_error_if_get_kb_fails(self, mock_get):
        mock_get.return_value = {"error": "not found", "_api_failed": True}
        result = update_kb_publish_strategy("kb-bad", "atomic")
        assert api_failed(result) is True

    @patch("services.api.kb.update_kb")
    @patch("services.api.kb.get_kb")
    def test_handles_missing_settings_key(self, mock_get, mock_update):
...
class TestKBDetails:
    ...
    @patch("services.api.kb._get")
    def test_get_kb_documents_clamps_page_params(self, mock_get):
        mock_get.return_value = {"items": []}
...
class TestCategoriesLifecycle:
    ...
    @patch("services.api.kb._get")
    def test_get_kb_coverage_gaps(self, mock_get):
