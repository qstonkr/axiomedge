...
class TestLLMRegistry:
    def _clear_test_entries(self, monkeypatch):
        ...
        from src.core.providers.llm import LLM_PROVIDER_REGISTRY
        snapshot = dict(LLM_PROVIDER_REGISTRY)
        monkeypatch.setattr(
            "src.core.providers.llm.LLM_PROVIDER_REGISTRY",
            dict(snapshot),
        )
    ...
    def test_register_decorator_adds_entry(self, monkeypatch):
        ...
        from src.core.providers.llm import LLM_PROVIDER_REGISTRY, register_llm_provider
    ...
    def test_create_llm_client_calls_registered_factory(self, monkeypatch):
        from src.core.providers.llm import LLM_PROVIDER_REGISTRY, create_llm_client
...
class TestAuthRegistry:
    def test_builtin_providers_registered(self):
        from src.core.providers.auth import AUTH_PROVIDER_REGISTRY
