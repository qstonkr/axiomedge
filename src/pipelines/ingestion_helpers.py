...
_L1_CATEGORIES_DEFAULT: list[dict[str, Any]] = [
    {"name": "IT인프라·운영", "keywords": ["서버", "배포", "장애", "모니터링", "인프라", "K8s", "쿠버네티스", "도커", "네트워크", "방화벽", "SSL", "DNS", "CDN"]},  # noqa: E501
    {"name": "시스템·애플리케이션", "keywords": ["시스템", "메뉴", "화면", "API", "POS", "WMS", "ERP", "앱", "UI", "UX", "프론트", "백엔드", "DB", "데이터베이스"]},  # noqa: E501
    {"name": "업무프로세스·규정", "keywords": ["프로세스", "절차", "규정", "감사", "인사", "회계", "재무", "결재", "양수도", "폐점", "계약", "정산", "담배권"]},  # noqa: E501
    {"name": "사업·전략", "keywords": ["매출", "전략", "KPI", "마케팅", "영업", "홈쇼핑", "실적", "성과", "사업분석", "상권분석", "경영전략"]},  # noqa: E501
    {"name": "유통·물류", "keywords": ["OFC", "발주", "배송", "재고", "물류", "점포", "가맹", "상품", "유통", "식품", "경영주", "편의점", "GS25", "진열", "경영", "상권", "ESPA"]},  # noqa: E501
