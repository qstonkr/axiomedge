...
DEFAULT_BASE_MODELS: list[dict[str, Any]] = [
    ...
    {
        "hf_id": "kakaocorp/kanana-1.5-2.1b-instruct",
        "display_name": "Kakao Kanana 1.5 2.1B",
        "params": "2.1B",
        "license": "Kanana 1.5 (상업 사용 가능)",
        "commercial_use": True,
        "verified": True,
        "notes": "한국어 정확 · 상업 OK · Kanana 1.5 모델",
        "enabled": True,
        "sort_order": 20,
    },
    {
    ...
    },
    {
        ...
        "params": "1.5B",
        "license": "HyperCLOVA X SEED (상업 가능, 조건부)",
        "commercial_use": True,
        "verified": True,
        "notes": "한국어 특화 · 상업 OK · 단 네이버 경쟁사 또는 MAU 1000만 이상 시 회수 권한 있음",
        "enabled": True,
        "sort_order": 40,
    },
