"""Admin API endpoints - graph stats, graph operations, Qdrant collections."""
...
async def graph_search(body: dict[str, Any]):
    ...
    try:
        results = await graph.search_entities(query, max_hops=max_hops)
...
async def run_graph_integrity_check():
