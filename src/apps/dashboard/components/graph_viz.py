...
def _build_expand_js(api_base_url: str) -> str:
    ...
    return (
        '            var _expandedIds = {};\n'
        '            console.log("[GraphViz] doubleClick expand handler attached (in-layer mode)");\n'
        '\n'
        ...
        '                console.log("[GraphViz] Expanding node:", nodeId);\n'
        '\n'
        '                fetch("' + expand_url + '", {\n'
        '                    method: "POST",\n'
        ...
        '                    console.log("[GraphViz] Expanded:", (data.neighbors || []).length, "nodes,", (data.edges || []).length, "edges");\n'
        '                })\n'
        '                .catch(function(err) {\n'
