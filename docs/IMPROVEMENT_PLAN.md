...
- [x] Kanana 1.5 모델 전환 (`commercial_use=True`) + HyperCLOVAX 상업 라이선스 반영
...
- [x] `src/connectors/confluence/attachment_parser.py` (36 tests — helpers, OCR policy, OLE, noise filter)
- [x] `src/distill/service.py` (11 tests — _prefer_reformatted, init)
